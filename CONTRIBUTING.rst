...
dj-libcloud could always use more documentation, whether as part of the 
official dj-libcloud docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
3. The pull request should work for Python 2.7, and 3.3. Check 
   https://travis-ci.org/pydanny/dj-libcloud/pull_requests
